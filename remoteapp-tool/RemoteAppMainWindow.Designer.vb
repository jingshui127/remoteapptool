...
Partial Class RemoteAppMainWindow
    ...
    Private Sub InitializeComponent()
        ...
        'RequiredCommandLine
        '
        Me.RequiredCommandLine.Text = "必需的命令行"
        '
        'CommandLineSetting
        '
        Me.CommandLineSetting.Text = "命令行设置"
        '
        'IconPath
        '
        ...
        'IconIndex
        '
        Me.IconIndex.Text = "图标索引"
        '
        'SecurityDescriptor
        '
        Me.SecurityDescriptor.Text = "安全描述符"
        '
        'ShowInTSWA
        '
        Me.ShowInTSWA.Text = "在TSWA中显示"
        '
        'SmallIcons
        '
        ...
        Me.NoAppsLabel.Text = "此计算机上没有托管 RemoteApp。" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "点击 + 添加一个。"
        ...
        Me.BackupSaveFileDialog.Filter = "Windows 注册表文件|*.reg"
        '
        'RemoteAppMainWindow
        '
